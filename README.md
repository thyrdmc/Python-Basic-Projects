...
## Python-Basic-Project-2 (find_your_speciality.py)
...
## Python-Basic-Project-3 (python_auction.py)
...
## Python-Basic-Project-4 (caesar_chiper.py)
...
## Python-Basic-Project-5 (rock-paper-scissors.py)
...
## Python-Basic-Project-6 (hangman.py)
 This project is for playing game with Computer that people who are bored. 
...
## Python-Basic-Project-7 (higher_lower_game.py)
...
## Python-Basic-Project-9 (password-generator.py)
 ...
 ## Python-Basic-Project-10 (blackjack-game.py)
...
<img width="524" alt="BlackJack Game" src="https://github.com/thyrdmc/Python-Basic-Projects/assets/62545306/c1d18eb5-9a16-4f98-96b5-a16a95d9a8a2">
 ...
 ## Python-Basic-Project-11 (guess-number.py)
...
## Python-Basic-Project-12 (flatten_and_reverse_function.py)
